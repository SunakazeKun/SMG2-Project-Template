...
namespace pt {
	namespace {
		/*
		* New variants can be easily added and created here. As usual, I redirected the calls to Shellfish::initItem to
		* check for my new variants first. At the end, the original function is called in order to initialize the other
		* existing item types and to set up the hit sensors and more.
		*/
